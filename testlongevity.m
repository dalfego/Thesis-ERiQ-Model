...
v = [1.028037069	0.925564864	0.907215964	1.043922218	1.010531421	0.986161729	0.978440906	1.136790235	1.057161767	0.982245003	0.998591931	0.956054414	1.032522004];

PTEN_SA = v(1); AKT_SA = v(2); NFKB_SA = v(3); P53_SA = v(4); 
AMPK_SA = v(5); PGC1a_SA = v(6); MTOR_SA = v(7); AUTO_SA = v(8); FOXO_SA = v(9);
SIRT_SA = v(10); HIF_SA = v(11); GLU_SA = 1; PYR_SA = 1; ROS_SA = 1;
MDR_SA = 1; NADr_SA = 1; MENZY_SA = v(12); GLYENZ_SA = v(13);
